...
class ReportService {
  ...
  /// Creates a PageTheme that renders the watermark as foreground
  /// on every page at 20% opacity. The foreground widget is painted
  /// using full page constraints so it can extend to the page center.
