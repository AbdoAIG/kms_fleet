...
class ReportService {
  ...
  /// Builds a small, semi-transparent watermark widget for use in
  /// pw.MultiPage's header parameter. Appears on every page.
    ...
    try {
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          header: (context) => buildPageWatermark(watermarkImage),
          build: (context) => [
              wrapContent([
                ...headerWidgets,
