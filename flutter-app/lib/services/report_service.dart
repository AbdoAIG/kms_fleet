...
class ReportService {
  ...
  /// Loads the watermark image from assets for PDF reports.
  ...
  /// The watermark is added separately via the MultiPage header parameter
  /// to avoid Stack-based pagination issues.
  ...
  /// Builds a watermark widget that appears centered on every page
  /// at 20% opacity behind the content.
    ...
    try {
      ...
      pdf.addPage(
        pw.MultiPage(
          ...
          header: (_) => pw.FullPage(ignoreMargins: true, child: buildPageWatermark(watermarkImage)),
          build: (context) => [
              wrapContent([
                ...headerWidgets,
